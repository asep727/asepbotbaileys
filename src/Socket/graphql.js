...
const executeFacebookGraphQL = (docId, variables, accessToken, dataPath = null, lang = 'en') => executeWWWGraphQL(docId, variables, accessToken, dataPath, lang, ENDPOINTS.ACS);
