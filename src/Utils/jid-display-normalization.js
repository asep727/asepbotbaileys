...
const mergeGroupDataHints = (hints, groupData, debug) => {
    ...
    for (const participant of groupData.participants) {
        ...
        const lid = ((0, WABinary_1.isLidUser)(lidCandidate) || (0, WABinary_1.isHostedLidUser)(lidCandidate)
            ? lidCandidate
            : undefined) ||
            ((0, WABinary_1.isLidUser)(idCandidate) || (0, WABinary_1.isHostedLidUser)(idCandidate) ? idCandidate : undefined);
        const pn = ((0, WABinary_1.isPnUser)(pnCandidate) || (0, WABinary_1.isHostedPnUser)(pnCandidate)
            ? pnCandidate
            : undefined) ||
